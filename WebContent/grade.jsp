...
<body link="#000" alink="017bf5" vlink="#000">
	...
	<h3 align="center">
		<a href="<%=request.getContextPath()%>/choosegrade"> <font
			face="Lato" color="#000">CHOOSE CLASS</font>
		</a>&nbsp;&nbsp;&nbsp; <br />
		<br /> <a href="<%=request.getContextPath()%>/newGradeForm"> <font
			face="Lato" color="#000">ADD CLASS</font>
		</a>&nbsp;&nbsp;&nbsp; <br />
		<br /> <a href="<%=request.getContextPath()%>/listGrade"> <font
			face="Lato" color="#000">CLASS's LIST</font>
		</a>
	</h3>
</body>
</html>
