...
<body link="#000" alink="017bf5" vlink="#000">
	...
	<h3 align="center">
		<a href="<%=request.getContextPath()%>/newTeacherForm"> <font
			face="Lato" color="#000">ADD TEACHERS</font>
		</a>&nbsp;&nbsp;&nbsp; <br />
		<br /> <a href="<%=request.getContextPath()%>/listTeacher"> <font
			face="Lato" color="#000">TEACHER's LIST</font>
		</a> <br />
		<br /> <a href="<%=request.getContextPath()%>/teacherSubjectForm">
