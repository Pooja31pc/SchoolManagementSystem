...
<body>
	...
	<br />
	<h3 align="center">
		<font face="Lato" color="#009879" size="5"> <u>Choose
				Required Standard from the List</u>
		</font> <br />
	</h3>
		...
		<tbody>
			...
			<c:forEach var="grade" items="${listGrade}">
				...
				<tr>
					...
					<td><a
						href="<%=request.getContextPath()%>/gradewisedetails?gid=<c:out value='${grade.getGid()}' />"><c:out
								value="${grade.getStandard()}" /></a></td>
