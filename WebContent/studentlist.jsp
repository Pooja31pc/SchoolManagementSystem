...
<body>
	...
	<h3>
		...
		</font> <a href="<%=request.getContextPath()%>/student">STUDENT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<hr />
		<a href="<%=request.getContextPath()%>/newStudentForm"> <font
			face="cinzel" size="4" color="#009879">ADD STUDENTS</font>
		</a>
	</h3>
	<hr />
	<br />
	<h3 align="center">
		<font face="Lato" color="#009879" size="5"> Student Details </font> <br />
	</h3>
